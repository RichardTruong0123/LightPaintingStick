...
void juggle_setup() {
// Routine specific variables
    numdots =   4;                                     // Number of dots in use.
   faderate =   2;                                     // How long should the trails be. Very low value = longer trails.
     hueinc =  16;                                     // Incremental change in hue between each dot.
    thishue =   0;                                     // Starting hue.
     curhue =   0;                                     // The current hue
    thissat = 255;                                     // Saturation of the colour.
 thisbright = 255;                                     // How bright should the LED/display be.
   basebeat =   5;                                     // Higher = faster movement.
...
void juggle_ChangeMe() {                                             // A time (rather than loop) based demo sequencer. This gives us full control over the length of each sequence.
