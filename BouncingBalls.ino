...
#define NUM_BALLS         10                  // Number of bouncing balls you want (recommend < 7, but 20 is fun in its own way)
...
void BouncingBallsStep()
{
    ...
    for (int i = 0; i < NUM_BALLS; i++)
    {
        ...
        h[i] =
            0.5 * GRAVITY * pow(tCycle[i] / 1000.0, 2.0) +
            vImpact[i] * (tCycle[i] / 1000.0);
